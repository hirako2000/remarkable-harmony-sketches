! function (e, t) {
	...
	function o(e, t, n, i, o) {
		e.style.cssText = "height: unset;position:fixed; top:".concat(o, "px; left:").concat(i, "px;")
	}
			...
			value: function () {
				...
				if (e = d, t = window.innerHeight || document.documentElement.clientHeight || document.body.clientHeight, i = e.offsetTop, o = e.offsetHeight, c = document.documentElement.scrollTop, o + i > c && i - c <= t + 100) {
					...
					var m = function (e) {
						...
						g = m.width,
						p = m.height;
					u.style.cssText = "height: unset;position:fixed; top:".concat(h, "px; left: ").concat(f, "px;")
...
<div class="image-container">
    <div class="img-content" id="image-content"><img id="preview-image" src="" alt="some-image" /></div>
</div>`,
